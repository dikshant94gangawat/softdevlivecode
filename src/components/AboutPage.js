...
const AboutPage = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Technical specialist with expertise in software architecture and full-stack development.',
      avatar: 'DG',
    ...
    },
    {
      name: 'Abhishek Dhang',
      role: 'Tech Specialist',
      description: 'Technical specialist specializing in backend systems and cloud solutions.',
      avatar: 'AD',
